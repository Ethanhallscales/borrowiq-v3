...
export const FLOW_A_STEPS: FlowAScreen[] = ["A1","A2","A3","A4","A5","A6","A7"];
export const FLOW_B_STEPS: FlowBScreen[] = ["B1","B2","B3","B4","B5","B6"];
export const FLOW_C_STEPS: FlowCScreen[] = ["C1","C2","C3","C4"];
export const FLOW_N_STEPS: FlowNScreen[] = ["N1","N2","N3","N4","N5","N5b","N6","N6b","N6c","N7"];
...
export type EmploymentType   = "payg" | "self-employed" | "contractor" | "casual";
